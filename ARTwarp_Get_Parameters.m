...
global vigilance bias learningRate maxNumCategories maxNumIterations sampleInterval resample callback2 minUI
...
h1 = uicontrol('Parent',h0,...
    'Units','points',...
    'BackgroundColor',[0.752941176470588 0.752941176470588 0.752941176470588], ...    
    'Callback', 'global minUI; minUI = not(minUI);',...
    'FontSize',10, ...
    'FontUnits','points',...
    'Position',[20 46 170 15], ...
    'String','Minimal GUI',...
    'Style','radiobutton',...
    'Value', minUI,...
    'Tag','minimalUI');
